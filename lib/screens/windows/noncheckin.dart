...
class noncheckin extends StatefulWidget {
  const noncheckin({super.key});

  @override
  State<noncheckin> createState() => _noncheckinrState();
}

class _noncheckinrState extends State<noncheckin> {
  @override
